...
class Meiyuewanchengshu(models.Model):
    now_year = models.CharField(max_length=32,unique=True,default='/')
    wancheng_1 = models.IntegerField(default=0)
    weiwancheng_1 = models.IntegerField(default=0)
    wancheng_2 = models.IntegerField(default=0)
    weiwancheng_2 = models.IntegerField(default=0)
    wancheng_3 = models.IntegerField(default=0)
    weiwancheng_3 = models.IntegerField(default=0)
    wancheng_4 = models.IntegerField(default=0)
    weiwancheng_4 = models.IntegerField(default=0)
    wancheng_5 = models.IntegerField(default=0)
    weiwancheng_5 = models.IntegerField(default=0)
    wancheng_6 = models.IntegerField(default=0)
    weiwancheng_6 = models.IntegerField(default=0)
    wancheng_7 = models.IntegerField(default=0)
    weiwancheng_7 = models.IntegerField(default=0)
    wancheng_8 = models.IntegerField(default=0)
    weiwancheng_8 = models.IntegerField(default=0)
    wancheng_9 = models.IntegerField(default=0)
    weiwancheng_9 = models.IntegerField(default=0)
    wancheng_10 = models.IntegerField(default=0)
    weiwancheng_10 = models.IntegerField(default=0)
    wancheng_11 = models.IntegerField(default=0)
    weiwancheng_11 = models.IntegerField(default=0)
    wancheng_12 = models.IntegerField(default=0)
    weiwancheng_12 = models.IntegerField(default=0)

    dangqianwanchengzongshu = models.IntegerField(default=0)
